...
public class InputUtility {
    ...
    public static int inputIntValueWithScanner(TeacherView view) {
        view.printMessage(TeacherMesseges.INPUT_INT_DATA);
        while (true) {
            try {
//                if (!sc.hasNextInt())
//                    throw new WrongInputException();
    ...
    public static String inputSaveTmp(TeacherView view) {
        view.printMessage(TeacherMesseges.SAVE_TMP);
        return sc.next();
    }

    public static String inputNameWithScanner(TeacherView view) {
        view.printMessage(TeacherMesseges.INPUT_STRING_NAME_DATA);
        return sc.next();
    }

    public static String inputSurnameWithScanner(TeacherView view) {
        view.printMessage(TeacherMesseges.INPUT_STRING_SURNAME_DATA);
        return sc.next();
    }

    public static String inputPatronymicWithScanner(TeacherView view) {
        view.printMessage(TeacherMesseges.INPUT_STRING_PATRONYMIC_DATA);
        return sc.next();
    }

    public static String inputGenderWithScanner(TeacherView view) {
        view.printMessage(TeacherMesseges.INPUT_STRING_GENDER_DATA);
        return sc.next();

    }

    public static String inputDisciplineWithScanner(TeacherView view) {
        view.printMessage(TeacherMesseges.INPUT_STRING_DISCIPLINE_DATA);
        return sc.next();
    }

    public static String inputCathedraWithScanner(TeacherView view) {
        view.printMessage(TeacherMesseges.INPUT_STRING_CATHEDRA_DATA);
        return sc.next();
    }

    public static String inputPostWithScanner(TeacherView view) {
        view.printMessage(TeacherMesseges.INPUT_STRING_POST_DATA);
        return sc.next();
    }
